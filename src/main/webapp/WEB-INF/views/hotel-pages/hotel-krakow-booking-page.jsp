        ...
        <div class="row">
                    ...
                    <div class="htlfndr-widget-content">
                        ...
                        <form name="search-Spagere" id="search-Spagere">
                            ...
                            <div id="htlfndr-input-1" class="htlfndr-input-wrapper">
                                <input type="text" name="htlfndr-city" id="htlfndr-city" class="search-Spagere-input" placeholder="Enter city, region" />
                            ...
                            <div class="htlfndr-float-input first-float">
                                ...
                                <div id="htlfndr-input-date-in" class="htlfndr-input-wrapper">
                                    <input type="text" name="htlfndr-date-in" id="htlfndr-date-in" class="search-Spagere-input"/>
                            ...
                            <div class="htlfndr-float-input">
                                ...
                                <div id="htlfndr-input-date-out" class="htlfndr-input-wrapper">
                                    <input type="text" name="htlfndr-date-out" id="htlfndr-date-out" class="search-Spagere-input"/>
                                    <button type="button" class="htlfndr-clear-datepicker"></button>
            ...
            <main class="col-sm-8 col-md-9 col-lg-9 htlfndr-search-result htlfndr-grid-view" role="main">
                ...
                <section class="row htlfndr-search-result-content">
                    <div class="col-md-4 htlfndr-Spagere-post-wrapper">
                        <div class="htlfndr-Spagere-post">
                            <a href="Spagere-page-v1.html" class="htlfndr-Spagere-thumbnail">
                                <img src="http://placehold.it/260x155" alt="pic" />
                            </a>
                            <div class="htlfndr-Spagere-description">
                                <div class="htlfndr-description-content">
                                    ...
                                    <div class="htlfndr-rating-stars" data-rating="5">
                                        ...
                                        <i class="fa fa-star htlfndr-star-color"></i>&nbsp;
                                        <i class="fa fa-star htlfndr-star-color"></i>&nbsp;
                                        <p class="htlfndr-Spagere-reviews">(<span>188</span> reviews)</p>
                                    </div><!-- .htlfndr-rating-stars -->
                                    <h5 class="htlfndr-Spagere-location"><a href="#"><i class="fa fa-map-marker"></i>san francisco united states</a></h5>
                                    <p class="htlfndr-last-booking">Last booking: <span>14</span> hours ago</p>
                                </div><!-- .htlfndr-description-content -->
                                <a href="Spagere-page-v1.html" role="button" class="htlfndr-select-Spagere-button">select</a>
                                <div class="htlfndr-Spagere-price">
                    ...
                    <div class="col-md-4 htlfndr-Spagere-post-wrapper">
                        <div class="htlfndr-Spagere-post">
                            <a href="Spagere-page-v3.html" class="htlfndr-Spagere-thumbnail">
                                <img src="http://placehold.it/260x155" alt="pic" />
                            </a>
                            <div class="htlfndr-Spagere-description">
                                <div class="htlfndr-description-content">
                                    <h2 class="htlfndr-entry-title"><a href="Spagere-page-v3.html">Awesome Suits</a></h2>
                                    <div class="htlfndr-rating-stars" data-rating="4">
                                        ...
                                        <p class="htlfndr-Spagere-reviews">(<span>128</span> reviews)</p>
                                    </div><!-- .htlfndr-rating-stars -->
                                    <h5 class="htlfndr-Spagere-location"><a href="#"><i class="fa fa-map-marker"></i>paris france</a></h5>
                                    <p class="htlfndr-last-booking">Last booking: <span>14</span> hours ago</p>
                                </div><!-- .htlfndr-description-content -->
                                <a href="Spagere-page-v3.html" role="button" class="htlfndr-select-Spagere-button">select</a>
                                <div class="htlfndr-Spagere-price">
                                    <span class="htlfndr-from">from</span> <span class="htlfndr-cost">$ 250</span> <span class="htlfndr-per-night">per night</span>
                    ...
                    <div class="col-md-4 htlfndr-Spagere-post-wrapper">
                        <div class="htlfndr-Spagere-post special-offer">
                            <a href="Spagere-page-v4.html" class="htlfndr-Spagere-thumbnail">
                                <img src="http://placehold.it/260x155" alt="pic" />
                            </a>
                            <div class="htlfndr-Spagere-description">
                                <div class="htlfndr-description-content">
                                    <h2 class="htlfndr-entry-title"><a href="Spagere-page-v4.html">Ruzzini Palace Spagere</a></h2>
                                    <div class="htlfndr-rating-stars" data-rating="3">
                                        ...
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <p class="htlfndr-Spagere-reviews">(<span>118</span> reviews)</p>
                                    </div><!-- .htlfndr-rating-stars -->
                                    <h5 class="htlfndr-Spagere-location"><a href="#"><i class="fa fa-map-marker"></i>san francisco united states</a></h5>
                                    <p class="htlfndr-last-booking">Last booking: <span>14</span> hours ago</p>
                                </div><!-- .htlfndr-description-content -->
                                <a href="Spagere-page-v4.html" role="button" class="htlfndr-select-Spagere-button">select</a>
                                <div class="htlfndr-Spagere-price">
                                    <span class="htlfndr-from">from</span> <span class="htlfndr-cost">$ 280</span> <span class="htlfndr-per-night">per night</span>
                    ...
                    <div class="col-md-4 htlfndr-Spagere-post-wrapper">
                        <div class="htlfndr-Spagere-post">
                            ...
                            <div class="htlfndr-Spagere-description">
                                <div class="htlfndr-description-content">
                                    <h2 class="htlfndr-entry-title"><a href="Spagere-page-v1.html">Aqua Palace</a></h2>
                                    <div class="htlfndr-rating-stars" data-rating="4">
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star"></i>
                                        <p class="htlfndr-Spagere-reviews">(<span>88</span> reviews)</p>
                                    </div><!-- .htlfndr-rating-stars -->
                                    <h5 class="htlfndr-Spagere-location"><a href="#"><i class="fa fa-map-marker"></i>san francisco united states</a></h5>
                                    <p class="htlfndr-last-booking">Last booking: <span>14</span> hours ago</p>
                                </div><!-- .htlfndr-description-content -->
                                <a href="Spagere-page-v1.html" role="button" class="htlfndr-select-Spagere-button">select</a>
                                <div class="htlfndr-Spagere-price">
                                    <span class="htlfndr-from">from</span> <span class="htlfndr-cost">$ 200</span> <span class="htlfndr-per-night">per night</span>
                    ...
                    <div class="col-md-4 htlfndr-Spagere-post-wrapper">
                        <div class="htlfndr-Spagere-post">
                            ...
                            <div class="htlfndr-Spagere-description">
                                <div class="htlfndr-description-content">
                                    <h2 class="htlfndr-entry-title"><a href="Spagere-page-v3.html">Foscari Palace</a></h2>
                                    <div class="htlfndr-rating-stars" data-rating="5">
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <p class="htlfndr-Spagere-reviews">(<span>178</span> reviews)</p>
                                    </div><!-- .htlfndr-rating-stars -->
                                    <h5 class="htlfndr-Spagere-location"><a href="#"><i class="fa fa-map-marker"></i>paris france</a></h5>
                                    <p class="htlfndr-last-booking">Last booking: <span>14</span> hours ago</p>
                                </div><!-- .htlfndr-description-content -->
                    ...
                    <div class="col-md-4 htlfndr-Spagere-post-wrapper">
                        <div class="htlfndr-Spagere-post">
                            ...
                            <div class="htlfndr-Spagere-description">
                                <div class="htlfndr-description-content">
                                    <h2 class="htlfndr-entry-title"><a href="Spagere-page-v1.html">Ruzzini Palace Spagere</a></h2>
                                    <div class="htlfndr-rating-stars" data-rating="3">
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <p class="htlfndr-Spagere-reviews">(<span>177</span> reviews)</p>
                                    </div><!-- .htlfndr-rating-stars -->
                                    <h5 class="htlfndr-Spagere-location"><a href="#"><i class="fa fa-map-marker"></i>san francisco united states</a></h5>
                                    <p class="htlfndr-last-booking">Last booking: <span>14</span> hours ago</p>
                                </div><!-- .htlfndr-description-content -->
                                <a href="Spagere-page-v1.html" role="button" class="htlfndr-select-Spagere-button">select</a>
                                <div class="htlfndr-Spagere-price">
                                    <span class="htlfndr-from">from</span> <span class="htlfndr-cost">$ 300</span> <span class="htlfndr-per-night">per night</span>
                    ...
                    <div class="col-md-4 htlfndr-Spagere-post-wrapper">
                        <div class="htlfndr-Spagere-post">
                            ...
                            <div class="htlfndr-Spagere-description">
                                <div class="htlfndr-description-content">
                                    <h2 class="htlfndr-entry-title"><a href="Spagere-page-v3.html">Spagere Alpina</a></h2>
                                    <div class="htlfndr-rating-stars" data-rating="5">
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <p class="htlfndr-Spagere-reviews">(<span>181</span> reviews)</p>
                                    </div><!-- .htlfndr-rating-stars -->
                                    <h5 class="htlfndr-Spagere-location"><a href="#"><i class="fa fa-map-marker"></i>san francisco united states</a></h5>
                                    <p class="htlfndr-last-booking">Last booking: <span>14</span> hours ago</p>
                                </div><!-- .htlfndr-description-content -->
                    ...
                    <div class="col-md-4 htlfndr-Spagere-post-wrapper">
                        <div class="htlfndr-Spagere-post">
                            ...
                            <div class="htlfndr-Spagere-description">
                                <div class="htlfndr-description-content">
                                    <h2 class="htlfndr-entry-title"><a href="Spagere-page-v1.html">Hilton Spagere</a></h2>
                                    <div class="htlfndr-rating-stars" data-rating="5">
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <p class="htlfndr-Spagere-reviews">(<span>98</span> reviews)</p>
                                    </div><!-- .htlfndr-rating-stars -->
                                    <h5 class="htlfndr-Spagere-location"><a href="#"><i class="fa fa-map-marker"></i>paris france</a></h5>
                                    <p class="htlfndr-last-booking">Last booking: <span>14</span> hours ago</p>
                                </div><!-- .htlfndr-description-content -->
                    ...
                    <div class="col-md-4 htlfndr-Spagere-post-wrapper">
                        <div class="htlfndr-Spagere-post special-offer">
                            <a href="Spagere-page-v2.html" class="htlfndr-Spagere-thumbnail">
                                <img src="http://placehold.it/260x155" alt="pic" />
                            </a>
                            <div class="htlfndr-Spagere-description">
                                <div class="htlfndr-description-content">
                                    <h2 class="htlfndr-entry-title"><a href="Spagere-page-v2.html">Spagere Colombina</a></h2>
                                    <div class="htlfndr-rating-stars" data-rating="3">
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star htlfndr-star-color"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <p class="htlfndr-Spagere-reviews">(<span>198</span> reviews)</p>
                                    </div><!-- .htlfndr-rating-stars -->
                                    <h5 class="htlfndr-Spagere-location"><a href="#"><i class="fa fa-map-marker"></i>san francisco united states</a></h5>
                                    <p class="htlfndr-last-booking">Last booking: <span>14</span> hours ago</p>
                                </div><!-- .htlfndr-description-content -->
                                <a href="Spagere-page-v2.html" role="button" class="htlfndr-select-Spagere-button">select</a>
                                <div class="htlfndr-Spagere-price">
                                    <span class="htlfndr-from">from</span> <span class="htlfndr-cost">$ 300</span> <span class="htlfndr-per-night">per night</span>
                                    <span class="cost">300</span>
                                </div><!-- .htlfndr-Spagere-price -->
...
<!-- Include Starrr Rating script file for Search Widget -->
